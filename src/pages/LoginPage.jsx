...
//     if (res?.success) {
//       navigate("/"); // ✅ setelah login redirect ke dashboard
//     } else {
...
const LoginPage = () => {
  ...
  useEffect(() => {
    // ✅ Cek apakah user baru logout karena session expired
    if (localStorage.getItem("sessionExpired") === "true") {
      setSessionExpired(true);
      localStorage.removeItem("sessionExpired"); // hapus agar gak muncul terus
    }
  }, []);
